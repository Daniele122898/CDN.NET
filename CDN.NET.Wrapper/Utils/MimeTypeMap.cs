...
{
    // Code from https://github.com/samuelneff/MimeTypeMap/blob/master/src/MimeTypes/MimeTypeMap.cs
    // Made it thread safe since the lazy loading wasn't initialized to be thread safe and didn't want to wait or deal with 
    // another repository and nuget package for such a simple file and addition.
    public static class MimeTypeMap
    {
        
        private static readonly Lazy<IDictionary<string, string>> _mappings = new Lazy<IDictionary<string, string>>(BuildMappings, LazyThreadSafetyMode.ExecutionAndPublication);
